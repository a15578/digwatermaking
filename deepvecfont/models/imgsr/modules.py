...
from deepvecfont.models.imgsr import networks
from deepvecfont.dataloader_sr import get_loader
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./deepvecfont/experiments', help='models are saved here')
        # model parameters
